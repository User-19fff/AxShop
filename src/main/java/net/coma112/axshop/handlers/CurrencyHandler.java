...
public class CurrencyHandler {
    public static void deduct(@NotNull Player player, double amount, @NotNull String currency) {
    ...
    public static void add(@NotNull Player player, double amount, @NotNull String currency) {
        var provider = CurrencyRegistry.get(currency);
